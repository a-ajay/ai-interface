...
class StandaloneTests {
  ...
  private async testEnhancerCore(): Promise<boolean> {
  ...
  private async testTokenOptimizer(): Promise<boolean> {
  ...
  private async testCacheManager(): Promise<boolean> {
    ...
    if (retrieved !== 'test value') return false;
