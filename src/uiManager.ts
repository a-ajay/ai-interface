...
import { EnhancedPrompt, Metrics, UIState, OrchestratorEvent } from './types';
...
export class UIManager {
   ...
   */
  public async showPromptPreview(
    ...
    const panel = vscode.window.createWebviewPanel(
      'promptPreview',
      'AI Orchestrator - Prompt Preview',
   ...
   */
  private getPreviewWebviewContent(originalPrompt: string, variants: EnhancedPrompt[]): string {
...
<body>
   ...
   */
  public updateMetrics(newMetrics: Partial<Metrics>): void {
    this.state.metrics = { 
